  ...
  if (loading) return (
    <div className="flex justify-center items-center min-h-screen" style={{ background: "#FAF6EC" }}>
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-sm" style={{ color: "rgba(74,85,104,0.7)" }}>Loading skill...</p>
      </div>
    </div>
  );
  ...
  return (
    <div className="min-h-screen pt-36 pb-16 px-4" style={{ background: "#FAF6EC" }}>
      <div className="max-w-2xl mx-auto">
        ...
        >
          <FiArrowLeft size={14} /> Back to My Skills
        </motion.button>
        ...
        >
          ...
          <div className="px-8 pt-8 pb-6" style={{ background: "linear-gradient(135deg, #1B2B4A, #14213D)" }}>
            <h1 className="text-3xl font-normal text-white" style={{ fontFamily: "'Playfair Display', serif" }}>Edit Skill</h1>
            <p className="text-sm mt-1" style={{ color: "rgba(255,255,255,0.55)" }}>Update your skill details below.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="px-8 py-8 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div>
                ...
                {estimatedMonthly && (
                  <p className="text-xs mt-1.5" style={{ color: "#A9863A" }}>≈ ${estimatedMonthly}/mo at 10 sessions</p>
                )}
              </div>
            </div>
                ...
                {form.tags.length > 0 && (
                  ...
                  >
                    {form.tags.map(tag => (
                      ...
                      >
                        {tag}
                        <button type="button" onClick={() => handleTagRemove(tag)} style={{ color: "#A9863A" }}>
                          <FiX size={11} />
                        </button>
                      </motion.span>
                    ))}
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={5}
                placeholder="What will learners gain? Describe your approach, topics, and who this is for..."
                required
