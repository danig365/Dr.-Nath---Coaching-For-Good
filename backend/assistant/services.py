...
SUMMARY_SYSTEM_PROMPT = (
    ...
    "ATTRIBUTION — this matters most: the transcript is labelled by speaker as "
    "\"Coach:\" and \"Client:\". Use these labels to attribute every statement, "
    "feeling, plan and situation to the correct person. Never swap who said "
    "something or whose plans, holiday, job or circumstances they are — if the "
    "coach mentions their own holiday, it is the coach's, not the client's.\n"
    "ACCURACY — do NOT state any specific fact such as a duration (e.g. \"three "
    "years in the role\"), number, date, place or name unless it is clearly and "
    "unambiguously stated in the transcript. The transcript may be imperfect or "
    "garbled by audio problems; when something is unclear, leave it out rather "
    "than guessing or filling gaps. It is better to be brief and correct than "
    "detailed and wrong.\n\n"
